      ...
      <div className="container mx-auto p-4 h-auto pt-40">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 text-sm">
            <li><strong>Nom de l'entreprise :</strong> Fixe</li>
            <li><strong>Forme juridique :</strong> [Forme juridique, par exemple, SARL, SAS, etc.]</li>
            <li><strong>Adresse du siège social :</strong> [Adresse complète de l'entreprise]</li>
            <li><strong>Numéro de SIRET :</strong> [Numéro de SIRET]</li>
            <li><strong>Numéro de TVA intracommunautaire :</strong> [Numéro de TVA]</li>
            <li><strong>Directeur de la publication :</strong> [Nom du directeur, par exemple, M. ou Mme X]</li>
            <li><strong>Responsable de la rédaction :</strong> [Nom du responsable]</li>
            <li><strong>Hébergeur du site :</strong> [Nom de l'hébergeur, adresse complète et coordonnées]</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm">
            L'utilisation du site internet [Nom du site] est soumise aux présentes conditions d'utilisation. En accédant à ce site, vous acceptez sans réserve ces conditions. L'accès à certains services peut nécessiter la création d'un compte ou la fourniture d'informations supplémentaires.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm">
            Fixe met tout en œuvre pour garantir l'exactitude des informations présentes sur ce site. Cependant, nous ne pouvons pas garantir que les informations sont complètes, exactes ou constamment à jour. En cas d'erreur, nous nous engageons à corriger ces informations dans les plus brefs délais.
          </p>
          <p className="text-sm">
            Le site peut contenir des liens vers d'autres sites externes. Fixe ne pourra être tenu responsable des contenus ou des pratiques de ces sites tiers.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm">
            Fixe se réserve le droit de modifier ou d'actualiser les présentes mentions légales à tout moment. Les utilisateurs sont invités à consulter régulièrement cette page pour prendre connaissance des modifications éventuelles.
          </p>
        </section>
