          ...
          <div   className="bg-transparent relative h-screen ">
              <div className="flex justify-center items-center lg:gap-8 xl:gap-0 px-10 ">
                  <div className="h-screen w-screen flex flex-col lg:col-span-7  items-center justify-center">
                    ...
                    <div className='flex flex-col justify-center text-center '>
                      <h1 className="max-w-2xl mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-7xl xl:text-9xl text-white ">Cette page n'existe pas</h1>
                    </div>
              ...
              <div className="absolute w-screen inset-0 -z-10 h-screen overflow-hidden ">         
                <div className='absolute h-full w-full bg-black opacity-40'></div>
                  <img src={photo1} alt="backgroundImage" className='object-cover h-full w-full' />
                  </div>     
            </div>
          </section>
  )
