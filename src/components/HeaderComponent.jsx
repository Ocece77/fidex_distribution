...
const HeaderComponent = ({titre, backgroundImage, desc, btns}) => {
  return (
    ...
    <div className="flex justify-center items-center lg:gap-8 xl:gap-0  lf px-10 ">
           ...
           <div className='flex flex-col justify-center text-center '>
            ...
            <div className='flex md:flex-row flex-col items-center  md:gap-0 gap-2 '>
            {
                Object.entries(btns).map(([key,val])=>{
                  return (
                    <Link to={val} className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-primary rounded-lg bg-white hover:bg-red-800 hover:text-white transition-all">
                    {key}
