...
const HeaderComponent = ({titre, backgroundImage, desc, btns}) => {
  ...
  return (
    ...
    className="bg-transparent relative h-screen mb-20">
      <div className="flex justify-center items-center lg:gap-8 xl:gap-0 px-10 ">
          <div className="h-screen w-screen flex flex-col lg:col-span-7  items-center justify-center">
            ...
            <div className='flex flex-col justify-center text-center '>
              <h1 className="max-w-2xl mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-7xl xl:text-9xl text-white ">{titre}</h1>
              ...
              <div className='flex md:flex-row flex-col items-center md:gap-0 gap-2 '>
              {
                  Object.entries(btns).map(([key,val],i)=>{
                    return (
                      <Link key={i} to={val} className="md:w-fit w-full inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-primary rounded-lg bg-white hover:bg-red-800 hover:text-white hover:gap-5 gap-2 transition-all">
                      {key}
      ...
      {/* Image */}
      <div  ref={bgRef} className="absolute w-screen inset-0 -z-10 h-screen overflow-hidden ">         
