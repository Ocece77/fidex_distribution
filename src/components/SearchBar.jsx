    ...
    <section className='grid grid-cols-1 gap-10'>
     {/*Titre*/}
       <div className="flex flex-col gap-4 w-full justify-center items-center text-center md:px-10">  
            ...
            <p>Entrer votre numéro de suivi afin de suivre votre colis</p>
         </div>

       <form onSubmit={handleSubmit} className="flex justify-center items-center w-screen mx-auto px-2 bg-white border-2 border-neutral-100 py-15 shadow-lg max-w-6xl">

        <label htmlFor="search" className="mb-2 text-sm font-medium text-primary sr-only">
        rechercher
        </label>
        ...
        <input
            type="search"
            id="search"
            className="block w-full px-10 py-6 md:ps-10 text-sm
