...
const StepCardsSection = ({titre="titre", desc="description" , cards=[] , btn={}}) => {
  return (
            ...
            {cards.map((card , i) => (
              ...
              <div key={i} className="rounded-lg shadow-[0_0px_10px_rgba(150,150,150,0.15)] h-full ">
                    ...
                    <div className="max-h-50 w-full">
                         <FontAwesomeIcon className="object-cover h-full w-full " icon={card.cardsLogo} alt="icon"/>
                       </div>
                ...
                <Link to={btn.btnLink} className="flex items-center px-5 py-3 bg-primary text-white transition-all hover:text-white hover:bg-red-800 hover:gap-5 gap-2  ">
